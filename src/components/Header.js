...
const Header = () => {
  ...
  return (
    <header>
      ...
      <div className={`backdrop ${btnOpen && "bg-active"}`}>
        <div className="mobile-nav">
          ...
          {!btnOpen && (
            <div className="ham" onClick={onToggleBtn}>
              <img className="ham-img" src={hamburger} alt="mobile icon" />
            </div>
          )}
          {btnOpen && (
            <div className="mob-links">
              <div className="close" onClick={oncloseBtn}>
                <img className="close-img" src={close} alt="mobile icon" />
              </div>
              hello
              <div className="mob-nav-social">
                <nav className="mob-navigation">
                  <ul>
                    ...
                    <li>
                      <button className="btn mb-login-btn">Login</button>
                    </li>
                  </ul>
                </nav>
